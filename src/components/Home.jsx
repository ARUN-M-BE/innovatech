...
const Home = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-gradient-to-br from-gray-800 to-purple-900 text-white">
      <Header />

      <main className="flex-1 w-full max-w-7xl px-4 md:px-6 py-24 mx-auto">
        {/* Hero Section */}
        <motion.div
          className="relative rounded-2xl bg-gradient-to-r from-purple-900/50 to-blue-900/50 p-8 md:p-12 mb-16"
        ...
        >
          ...
          <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full font-bold hover:scale-105 transition-transform duration-300 shadow-lg flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[1, 2, 3, 4, 5].map((item) => (
              ...
              >
                ...
                <div className="p-3">
                  <h3 className="text-white font-medium truncate">Popular {item}</h3>
